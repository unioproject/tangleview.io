<div class="banner-wrapper">
    ...
    <div class="banner text-center">
        <div id="iota-logo" class="">
            <img class="logo" src="img/iota_black.png" alt="IOTA">
        </div>
        <h1 class="headline">tangleview.io</h1>
        <span class="tagline">Tangle Analytics & Visualization</span>
    </div>
</div>

<div id="landingpage-info" class="row flex-column flex-hcenter">
    ...
    <!--
  <div class="signup-wrapper border-normal flex bold text-center">
    <span class="flex">During BETA there are no service fees!</span>
    <a href="/account">
      <div class="signup-button flex nav-button border-normal margin-left5 margin-right5">
        Sign-up
      </div>
    </a>
    <span class="flex">and check out the tangle&shy;nodes service</span>

  </div>
  -->


    <h2 class="text-center bg-header border-normal">Features</h2>
    ...
    <div class="info-features-wrapper flex flex-hcenter">
        ...
        <div class="info-features">
            ...
            <div class="bg-grey info-features-text">
                ...
                handy for any Tangle related project you are working on.
            </div>
        </div>
        ...
        <div class="info-features">
            <div class="flex-center flex-hcenter bigger-text text-center bold"><img src="img/features/iota_black.png"
                    alt="">Advanced features</div>
            <div class="bg-grey info-features-text">
                We also plan to integrate some fancy new features and improvements, which will be implemented within the
                course of the next months. So stay tuned!
            </div>
        </div>
    ...
    <!--
      <div class="info-features bg-grey border-normal">
        <h2 class="text-center bg-header">Features & Advantages</h2>

          <ul>
            <li>Enjoy the comfort to flexibly deploy IOTA nodes for any task or situation: You want to participate on a community spam-event?
              Just deploy up to 20 nodes simultaniously and start your spammers. You are a developer and need some testing of your new App?
              Just deploy the amount of nodes required within the geographic regions you like.</li>
            <li>Payments are without creditcard, paypal or bank account. You only need some tokens. Tanglenodes.io runs a custom IOTA payment gateway which enables quick order processing and feeless transactions.</li>
            <li>No bothering about maintenance anymore. All nodes you deploy are always up-to-date and adapt to any circumstances or situations which may occur on the network.</li>
          </ul>
